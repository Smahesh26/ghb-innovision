    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-white via-white to-neutral-100 py-24 text-white">
        ...
        <div className="relative mx-auto max-w-5xl px-6">
          <div className="relative overflow-hidden rounded-3xl border border-[#202228] bg-[#111216] p-10 shadow-[0_24px_64px_rgba(15,15,18,0.35)] sm:p-14">
            ...
            <div className="relative grid gap-6 sm:grid-cols-2">
              {/* Email */}
              <div className="group rounded-2xl border border-white/10 bg-[#191b21] p-6 transition hover:border-[#EF2B2D]/50 hover:bg-[#1d2027]">
