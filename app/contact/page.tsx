...
export default function ContactPage() {
  return (
    <>
      ...
      <section className="relative h-[58vh] w-full overflow-hidden bg-gradient-to-br from-[#0d0d0f] via-[#1a1a1d] to-[#0d0d0f]">
        <div
        ...
        <div className="relative mx-auto flex h-full max-w-6xl flex-col items-center justify-center px-6 pt-52 sm:pt-56 text-center text-white">
